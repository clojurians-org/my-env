...
export NIX_PATH=nixpkgs=/home/op/.nix-defexpr/channels/nixpkgs:nixpkgs-static=/home/op/.nix-defexpr/channels/nixpkgs-static

echo 'sandbox = false' > /etc/nix/nix.conf
bash -x nix.sh install op@localhost tgz.nix

wget https://matthewbauer.us/nix.sh
mv $t/dat/nix-x86_64 $HOME/bin/nix
nix --store ~ -f channel:nixpkgs-unstable 

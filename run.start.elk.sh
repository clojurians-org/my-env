...
echo -e "\n==== sh nix.sh start 10.132.37.33:9092 apache-kafka-2.12-1.1.0 --zookeeper ${ZK_ALL}"
                sh nix.sh start 10.132.37.33:9092 apache-kafka-2.12-1.1.0 --zookeeper ${ZK_ALL}
echo -e "\n==== sh nix.sh start 10.132.37.34:9092 apache-kafka-2.12-1.1.0 --zookeeper ${ZK_ALL}" 
                sh nix.sh start 10.132.37.34:9092 apache-kafka-2.12-1.1.0 --zookeeper ${ZK_ALL}
echo -e "\n==== sh nix.sh start 10.132.37.35:9092 apache-kafka-2.12-1.1.0 --zookeeper ${ZK_ALL}" 
                sh nix.sh start 10.132.37.35:9092 apache-kafka-2.12-1.1.0 --zookeeper ${ZK_ALL}
...
echo -e "\n==== sh nix.sh start 10.132.37.36:5601 logstash-6.2.4 -e ${ES_ALL}" && sh nix.sh start 10.132.37.36:5601 logstash-6.2.4 -e ${ES_ALL}

...
echo -e "\n==== sh nix.sh start 10.132.37.33:2181 zookeeper-3.4.12 --all ${ZK_ALL}" && sh nix.sh start 10.132.37.33:2181 zookeeper-3.4.12 --all ${ZK_ALL}
echo -e "\n==== sh nix.sh start 10.132.37.34:2181 zookeeper-3.4.12 --all ${ZK_ALL}" && sh nix.sh start 10.132.37.34:2181 zookeeper-3.4.12 --all ${ZK_ALL}
echo -e "\n==== sh nix.sh start 10.132.37.35:2181 zookeeper-3.4.12 --all ${ZK_ALL}" && sh nix.sh start 10.132.37.35:2181 zookeeper-3.4.12 --all ${ZK_ALL}
